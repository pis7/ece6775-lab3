...
set portList { 
	...
	{ sorted_distances_V_address0 sc_out sc_lv 5 signal 1 } 
	{ sorted_distances_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ sorted_distances_V_we0 sc_out sc_logic 1 signal 1 } 
	{ sorted_distances_V_d0 sc_out sc_lv 6 signal 1 } 
	{ sorted_distances_V_q0 sc_in sc_lv 6 signal 1 } 
	{ sorted_distances_V_address1 sc_out sc_lv 5 signal 1 } 
	{ sorted_distances_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ sorted_distances_V_we1 sc_out sc_logic 1 signal 1 } 
	{ sorted_distances_V_d1 sc_out sc_lv 6 signal 1 } 
	{ sorted_distances_V_q1 sc_in sc_lv 6 signal 1 } 
	{ sorted_labels_V_address0 sc_out sc_lv 5 signal 2 } 
	{ sorted_labels_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ sorted_labels_V_we0 sc_out sc_logic 1 signal 2 } 
	{ sorted_labels_V_d0 sc_out sc_lv 4 signal 2 } 
	{ sorted_labels_V_q0 sc_in sc_lv 4 signal 2 } 
	{ sorted_labels_V_address1 sc_out sc_lv 5 signal 2 } 
	{ sorted_labels_V_ce1 sc_out sc_logic 1 signal 2 } 
	{ sorted_labels_V_we1 sc_out sc_logic 1 signal 2 } 
	{ sorted_labels_V_d1 sc_out sc_lv 4 signal 2 } 
	{ sorted_labels_V_q1 sc_in sc_lv 4 signal 2 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2752", "Max" : "2752"}
	, {"Name" : "Interval", "Min" : "2752", "Max" : "2752"}
]}
