...
wire   [1:0] i_2_fu_575_p2;
reg   [1:0] i_2_reg_1048;
...
wire   [0:0] icmp_ln895_1_fu_790_p2;
...
assign i_1_fu_838_p2 = (2'd1 + val_assign_reg_450);

assign i_2_fu_575_p2 = (i3_0_reg_373 + 2'd1);
...
assign icmp_ln895_1_fu_790_p2 = ((val_assign_reg_450 == 2'd1) ? 1'b1 : 1'b0);
...
assign select_ln895_fu_796_p3 = ((icmp_ln895_1_fu_790_p2[0:0] === 1'b1) ? freqs_1_V_2_reg_353 : freqs_2_V_2_reg_343);
