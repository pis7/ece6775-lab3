...
architecture behav of knn_vote is 
    ...
    signal i_2_fu_575_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal i_2_reg_1048 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal i_1_fu_838_p2 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal icmp_ln895_1_fu_790_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    dut_mux_32_4_1_1_U35 : component dut_mux_32_4_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 4,
    ...
    dut_mux_32_4_1_1_U36 : component dut_mux_32_4_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 4,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln169_fu_569_p2 = ap_const_lv1_1))) then 
                ...
                val_assign_reg_450 <= i_1_fu_838_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    i_1_fu_838_p2 <= std_logic_vector(unsigned(ap_const_lv2_1) + unsigned(val_assign_reg_450));
    i_2_fu_575_p2 <= std_logic_vector(unsigned(i3_0_reg_373) + unsigned(ap_const_lv2_1));
    ...
    icmp_ln895_1_fu_790_p2 <= "1" when (val_assign_reg_450 = ap_const_lv2_1) else "0";
    ...
    select_ln895_fu_796_p3 <= 
        freqs_1_V_2_reg_353 when (icmp_ln895_1_fu_790_p2(0) = '1') else 
        freqs_2_V_2_reg_343;
